...
export function getClosestObjectFromPlayer(range: number) {
  return getClosestVectorFromGroup(alt.Player.local.pos, [...alt.LocalObject.all], range);
}
