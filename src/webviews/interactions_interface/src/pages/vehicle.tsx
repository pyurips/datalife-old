...
export default function Vehicle() {
  return (
    <div className="flex flex-col items-center justify-between w-[200px] h-full">
      <div className="flex flex-col rounded-xl overflow-hidden bg-stone-900 w-full">
        <img
      ...
      <div className="flex flex-row items-center gap-2 w-full bg-stone-900 p-2 rounded-xl">
