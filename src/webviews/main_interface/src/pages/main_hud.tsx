      ...
      <div className="flex flex-row items-center justify-between">
        ...
        <div className="flex flex-row items-center gap-[1vw] bg-stone-950/75 p-[0.5vw] rounded-[0.5vw]">
          <div className="flex flex-col gap-[0.5vw]">
            <Progress className="w-[7vw] h-[0.5vw]" value={100} />
            <Progress className="w-[7vw] h-[0.5vw]" value={100} />
          </div>
          <div className="flex flex-col gap-[0.1vw] items-center">
            <PiBowlFoodFill className="text-[1.6vw]" />
            <Progress className="w-[3vw] h-[0.5vw]" value={100} />
          </div>
          <div className="flex flex-col gap-[0.1vw] items-center">
            <BiSolidDrink className="text-[1.6vw]" />
            <Progress className="w-[3vw] h-[0.5vw]" value={100} />
          </div>
          <div className="flex flex-col gap-[0.1vw] items-center">
            <FaToiletPaper className="text-[1.6vw]" />
            <Progress className="w-[3vw] h-[0.5vw]" value={100} />
          </div>
          <div className="flex flex-col gap-[0.1vw] items-center">
            <IoBedSharp className="text-[1.6vw]" />
            <Progress className="w-[3vw] h-[0.5vw]" value={35} />
          </div>
        </div>
      </div>
